...
print("         ram_address_0 <= std_logic_vector(to_unsigned(" + str(0) +",8));")
print("         ena_0 <= '1';")
x=1
for i in xrange(3,pixel_x*pixel_x - 1,4):
    print("     elsif ( prevneurons_spike(" +  str((pixel_x*pixel_x-1)-i-1) + ") = '1') then")
    print("         ram_Address_0 <= std_logic_vector(to_unsigned(" + str(x) + ",8));")
    print("         ena_0 <= '1';")
    x=x+1
print("     else")
print("         ram_Address_0 <= (others => 'Z');")
...
print("         ram_address_1 <= std_logic_vector(to_unsigned(" + str(0) +",8));")
print("         ena_1 <= '1';")
x=1
for i in xrange(4,pixel_x*pixel_x - 1,4):
    print("     elsif ( prevneurons_spike(" +  str((pixel_x*pixel_x-1)-i-1) + ") = '1') then")
    print("         ram_Address_1 <= std_logic_vector(to_unsigned(" + str(x) + ",8));")
    print("         ena_1 <= '1';")
    x=x+1
print("     else")
print("         ram_Address_1 <= (others => 'Z');")
...
print("         ram_address_2 <= std_logic_vector(to_unsigned(" + str(0) +",8));")
print("         ena_2 <= '1';")
x=1
for i in xrange(5,pixel_x*pixel_x - 1,4):
    print("     elsif ( prevneurons_spike(" +  str((pixel_x*pixel_x-1)-i-1) + ") = '1') then")
    print("         ram_Address_2 <= std_logic_vector(to_unsigned(" + str(x) + ",8));")
    print("         ena_2 <= '1';")
    x=x+1
print("     else")
print("         ram_Address_2 <= (others => 'Z');")
...
print("         ram_address_3 <= std_logic_vector(to_unsigned(" + str(0) +",8));")
print("         ena_3 <= '1';")
x=1
for i in xrange(6,pixel_x*pixel_x - 1,4):
    print("     elsif ( prevneurons_spike(" +  str((pixel_x*pixel_x-1)-i-1) + ") = '1') then")
    print("         ram_Address_3 <= std_logic_vector(to_unsigned(" + str(x) + ",8));")
    print("         ena_3 <= '1';")
    x=x+1
print("     else")
print("         ram_Address_3 <= (others => 'Z');")
